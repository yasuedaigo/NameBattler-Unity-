...
public class CharacterRepository : IFRepository
{
    ...
    public List<PlayerDTO> getPlayerDTOList(TableNames table){
        ...
        foreach(DataRow dr in dataTable.Rows){
            ...
            if(dr["CREATE_AT"] != null){
                playerDTO.CreateDay = DateTime.Parse((string)dr["CREATE_AT"]);
            }
    ...
    public PlayerDTO getPlayerDTO(string playername,TableNames table){
        return this.getPlayerDTOList(table).Find(n => n.PlayerName == playername);
    }
