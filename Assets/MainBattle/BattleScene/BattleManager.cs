...
public class BattleManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        player1 = new Ninja("ninnja");
        player2 = new Priest("souryo");
        player3 = new Wizard("mahoutukai");
        player100 = new Fighter("alexisandar");
        player200 = new Ninja("huuma");
        player300 = new Priest("agon");
        player1.team = 1;
        player2.team = 1;
        player3.team = 1;
        player100.team = 2;
